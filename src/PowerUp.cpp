...
PowerUp::PowerUp(const std::string& textureFile, sf::Vector2f position):animation(0.1f)
{
...
void PowerUp::update(float dt, unsigned int windowWidth, unsigned int windowHeight) {
